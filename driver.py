...
starting_board = sys.argv[1]
# starting_boards = np.genfromtxt('sudokus_start.txt', dtype='string', delimiter = ",")
# starting_board = starting_boards[0]
# print 'starting_board:\t{}'.format(starting_board)
...
if not ac3_solved:
    ...
    bt_output = ''
    for key in sorted(bt_board.iterkeys()): bt_output += bt_board[key][0]
    bt_output += ' BTS'
    print (bt_output)
    np.savetxt('output.txt', [bt_output], fmt='%s')